...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/pengumuman/detailpengumuman.css') }}">
</head>
...
<body>
    ...
    <div class="container">
        <div class="header-detail">
            <img alt="Decorative banner with red and white ribbons and Indonesian national emblem" height="200"
                src="{{ asset('img/pengumuman/pengumuman.png') }}" width="1000" />
        </div>
        <div class="content">
            <p>
                Peringati Hari Kemerdekaan Indonesia ke-79 tahun ini, mengambil tema “Nusantara Baru, Indonesia Baru”
                mencerminkan momentum transisi besar yang dihadapi pemerintah indonesia.
            </p>
            <p>
                Kecamatan Sungai Raya memiliki penduduk sebanyak 216.643 jiwa ditahun 2020, dengan kepadatan penduduk
                233,12 jiwa/km². Sebagai ibukota kabupaten, kecamatan Sungai Raya memiliki beragam Suku, Agama dan Ras
                serta Adat istiadat. Berdasarkan data
                <a href="#">
                    Badan Pusat Statistik
                </a>
                2020, penduduk Sungai Raya mayoritas memeluk agama Islam yakni 74,77%, kemudian Budha 13,72%, Kristen
                11,12% (Katolik 5,59%)
            </p>
            <div class="info">
                <p>
            ...
            <p>
                Surat/Pengumuman Ini dikhususkan yang telah terima Undangan Resmi dari Kantor bupati
            </p>
        </div>
    </div>
