...
<body>
    ...
    <div class="container">
        <div class="header-suiraya">
            <h1>Kecamatan Batu ampar</h1>
            <p>Kabupaten Kubu Raya - Kalimantan Barat</p>
            <p>Memiliki 22 Desa</p>
        </div>

        <div class="map">
            <img src="{{ asset('img/kecamatan/batuampar.png') }}" alt="Peta Kecamatan Sungai Raya" />
        </div>
        ...
        <div class="section-title">Profile Kecamatan Batu ampar</div>
