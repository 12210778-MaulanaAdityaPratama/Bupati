...
<body>
    ...
    <div class="container">
        <div class="header-suiraya">
            <h1>Kecamatan Sungai Kakap</h1>
            <p>Kabupaten Kubu Raya - Kalimantan Barat</p>
            <p>Memiliki 22 Desa</p>
        </div>

        <div class="map">
            <img src="{{ asset('img/kecamatan/sungaikakap.png') }}" alt="Peta Kecamatan Sungai Raya">
        </div>

        <div class="description">
            Kecamatan Sungai Raya memiliki penduduk sebanyak 216.643 jiwa ditahun 2020, dengan kepadatan penduduk 233,12
            jiwa/km². Sebagai ibukota kabupaten, kecamatan Sungai Raya memiliki beragam Suku, Agama dan Ras serta Adat
            istiadat. Berdasarkan data Badan Pusat Statistik 2020, penduduk Sungai Raya mayoritas memeluk
            agama Islam yakni 74,77%, kemudian Budha 13,72%, Kristen 11,12% (Katolik 5,59% dan Protestan 5,53%),
            kemudian Konghucu 0,22% dan sebagian kecil memeluk agama Hindu 0,16%, dan kepercayaan 0,01%.[2] Penduduk
            dari suku Melayu, Tionghoa, Dayak, merupakan warga asli kawasan ini. Dan juga penduduk pendatang seperti
            suku Jawa, Bugis, Madura, Batak, dan lainnya.
        </div>

        <div class="section-title">Profile Kecamatan Sungai Kakap</div>
