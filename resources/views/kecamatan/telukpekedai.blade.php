...
<body>
    ...
    <div class="container">
        <div class="header-suiraya">
            <h1>Kecamatan Teluk Pekedai</h1>
            <p>Kabupaten Kubu Raya - Kalimantan Barat</p>
            <p>Memiliki 22 Desa</p>
        </div>

        <div class="map">
            <img src="{{ asset('img/kecamatan/telukpakedai.png') }}" alt="Peta Kecamatan Sungai Raya" />
        </div>
        ...
        <div class="section-title">Profile Kecamatan Teluk Pekedai</div>
