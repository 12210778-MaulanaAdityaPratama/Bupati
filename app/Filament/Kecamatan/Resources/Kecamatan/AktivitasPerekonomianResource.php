...
use App\Filament\Kecamatan\Resources\Kecamatan\AktivitasPerekonomianResource\Pages;
use App\Filament\Kecamatan\Resources\Kecamatan\AktivitasPerekonomianResource\RelationManagers;
use App\Models\AktivitasPerekonomian;
use Filament\Forms;
...
class AktivitasPerekonomianResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListAktivitasPerekonomians::route('/'),
            'create' => Pages\CreateAktivitasPerekonomian::route('/create'),
            'edit' => Pages\EditAktivitasPerekonomian::route('/{record}/edit'),
        ];
    }
}
