...
use App\Filament\Kecamatan\Resources\Kecamatan\EkonomiAngkatanKerjaResource\Pages;
use App\Filament\Kecamatan\Resources\Kecamatan\EkonomiAngkatanKerjaResource\RelationManagers;
use App\Models\EkonomiAngkatanKerja;
use Filament\Forms;
...
class EkonomiAngkatanKerjaResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListEkonomiAngkatanKerjas::route('/'),
            'create' => Pages\CreateEkonomiAngkatanKerja::route('/create'),
            'edit' => Pages\EditEkonomiAngkatanKerja::route('/{record}/edit'),
        ];
    }
}
